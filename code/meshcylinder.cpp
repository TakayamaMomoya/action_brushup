...
namespace
{
const char* TEX_PATH = "data\\TEXTURE\\EFFECT\\boost.png";	// テクスチャファイル名
}

//=====================================================
// コンストラクタ
//=====================================================
CMeshCylinder::CMeshCylinder(int nPriority) : CObject(nPriority), m_meshCylinder(), m_pIdxBuff(nullptr), m_pVtxBuff(nullptr), m_col{}, m_nIdxTexture(-1)
{
